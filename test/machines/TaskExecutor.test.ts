...
describe('TaskExecutor', () => {
  ...
  test('run every other task failing', async ({
    failIds,
    taskQueue,
    taskExecutor,
    executedTasks,
  ...
  test('halting if failing to update task - successHook', async ({
    config,
    taskQueue,
    taskHooks,
  }) => {
  ...
  test('halting if failing to update task - failureHook', async ({
    config,
    taskQueue,
    taskHooks,
  }) => {
